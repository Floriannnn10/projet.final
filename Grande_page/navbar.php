         ...
         <div class="container-fluid">
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                     <!-- <li class="nav-item">
                         <a style="color: black; font-size:20px; margin-left:20px;" class="nav-link" href="dashboard.html">Dashboard</a>
                     </li> -->
                     <li class="nav-item">
                         <a style="color: black; font-size:20px; margin-left:20px;" class="nav-link" href="index2.php">Accueil</a>
                     </li>
                     <li class="nav-item">
                         <a style="color: black; font-size:20px; margin-left:20px;" class="nav-link" href="#">Boutique</a>
                     </li>
